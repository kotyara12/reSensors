...
// BSEC output type
typedef enum {
  BME68x_BSEC2_RESISTANCE = 0,
  BME68x_BSEC2_GAS_PERCENTAGE = 1,
  BME68x_BSEC2_IAQ = 2,
  BME68x_BSEC2_STATIC_IAQ = 3,
  BME68x_BSEC2_CO2_EQUIVALENT = 4,
  BME68x_BSEC2_BREATH_VOC_EQUIVALENT = 5
} BME68x_BSEC2_OUTPUT;

class BSEC68x : public rSensor {
  public:
    ...
    void setSensorItems(rSensorItem* itemPressure, rSensorItem* itemTemperature, rSensorItem* itemHumidity, rSensorItem* itemIAQ);
    ...
    sensor_value_t getIAQ(const bool readSensor);
  protected:
