...
- Встроенные настраиваемные фильтры данных. На данный момент реализованы: 
    - SENSOR_FILTER_AVERAGE (среднее)
    - SENSOR_FILTER_MEDIAN (медиана) с возможностью изменения размера буфера. 
По умолчанию фильтрация отключена (SENSOR_FILTER_RAW).
